...
messages = [
    {
        ...
        "content": (
            ...
            "  5) verificar que haya mesas disponibles para la fecha y hora elegidas por el cliente, usando la herramienta find_table del mcp\n"
            "  6) solicitar al cliente el nombre bajo el que va a reservar y su número de teléfono\n"
            "  7) listar todos los datos completos incluyendo las notas exactas que el cliente proporcionó, y esperar confirmación por parte del cliente para hacer la reserva\n"
            "  8) realizar la reserva usando reserve_table INCLUIENDO SIEMPRE el parámetro 'notes' con el CONTENIDO EXACTO que el cliente proporcionó. Si el cliente NO tiene notas, escribir 'Sin notas especiales'\n"
